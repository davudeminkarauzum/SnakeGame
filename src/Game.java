...
public class Game {
    String choice;
    enigma.console.Console cn = Enigma.getConsole("Snake Game", 80, 20, 20);
    ...
    public static Snake[] snakes = new Snake[100];
        ...
        if (choice.equals("1")) {
            ...
            while (true) {
                ...
                if(choice.equals("Y")) {
                    ...
                    px = 0; py = 0; playerscore = 0; cx = 0; cy = 0; computerscore = 0;
